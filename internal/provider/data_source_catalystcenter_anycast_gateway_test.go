...
func TestAccDataSourceCcAnycastGateway(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.catalystcenter_anycast_gateway.test", "multiple_ip_to_mac_addresses", "false"))
	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { testAccPreCheck(t) },
		ProtoV6ProviderFactories: testAccProtoV6ProviderFactories,
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceCcAnycastGatewayPrerequisitesConfig+testAccDataSourceCcAnycastGatewayConfig(),
...
const testAccDataSourceCcAnycastGatewayPrerequisitesConfig = `
